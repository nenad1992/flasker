...
def dashboard():
    ...
    if request.method == "POST":
        ...
        # Grab image name
        pic_file_name = secure_filename(name_to_update.profile_pic.filename)
        # Set UUID
        ...
        try:
            ...
            flash("Error! Looks like there is a problem... Try again")
            return render_template("dashboard.html",
                                   form=form,
                                   name_to_update=name_to_update)
    else:
...
class Posts(db.Model):
    ...
    poster_id = db.Column(db.Integer, db.ForeignKey('users.id')) # users- u je malo jer se vrsi poziv iz baze
                                                                # Iako je klasa Users, veliko slovo u bazi je malo.
...
class Users(db.Model, UserMixin):
    ...
    posts = db.relationship('Posts', backref='poster') # U ovom slucaju pokazuje na klasu Posts
